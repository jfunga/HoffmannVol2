...
\begin{extrabox}
\subsection*{\makebox[\linewidth][c]{$\bigstar$\; Número de Euler $\ee$}}
\vspace{0.85ex}
...
\vspace{2ex}
\subsection*{\makebox[\linewidth][c]{$\bigstar$\; Constante de Euler--Mascheroni $\gamma$}}
...
y se representan con la letra $\mathbb{R}$  
...
\begin{center}
{\Large\textbf{ESQUEMA DE CONJUNTOS NUMÉRICOS} \textit{... por ahora}}
\end{center}
